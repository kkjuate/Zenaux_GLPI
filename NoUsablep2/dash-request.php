...
if(isset($_SESSION['user'])){
    ...
    if($_SESSION['user'][2] == 'BOGATIT') {
        ...
        header('Location:dash-user-request.php');
        die();
    }
...
?>
     ...
     <form action="includes/user_request.inc.php" method="POST" class="flex-form" enctype="multipart/form-data">
       <div class="form-group">
            ...
            <input type="text" name="userAffected" class="form-control inputbox" placeholder="NT User! (Name doesn't work)" autofocus>
            
            
             <input type="checkbox" name="wfm-checker" value="WFH" >
