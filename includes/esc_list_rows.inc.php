...
while($row = sqlsrv_fetch_array($result))  
     ...
     ?>  
                             <tr>
                          <td><a href='esc-ticket.php?ticketN=<?php echo $ticketNumber; ?>'class='ticketNumber py-1 px-2 <?php echo $style; ?>'  data-toggle="tooltip" data-placement="right" title="<?php echo $tooltip; ?>"><?php echo $site.$ticketNumber; ?></a></td>
                            <td data-toggle="tooltip" data-placement="right" title="<?php echo $minDesc;?>"> <?php echo $issueDescription;  ?></td>  
                                    ...
                                    <td><?php echo $date;?></td>  
                                    <td><a href='esc-ticket.php?ticketN=<?php echo $ticketNumber; ?>' class='<?php echo $style; ?>' hidden><?php echo $ticketStatus; ?></a><a href='#'></a><?php echo $ticketOwner; ?></td>    
                                    <td><?php echo $LOB;?></td> 
				               </tr> 
