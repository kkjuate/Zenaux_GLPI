...
$query ="select t.location, t.ticketNumber, t.description, A.userFName as agentName, t.dateInitial, t.ticketStatus,  B.userFName as ticketOwner, t.LOB, caseIds.issueDescryption from ticket as t LEFT JOIN userInfo as A on t.affectedUserNT = A.userNt LEFT JOIN userInfo as B on t.ntUser = B.userNt LEFT JOIN caseIds on t.caseID = caseIds.idCase where t.location = '$site' AND t.ticketStatus != 'open';"; 
